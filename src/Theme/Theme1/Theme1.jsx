...
import { Heading, Text, Box, Badge, Textarea } from "@chakra-ui/react";
import "./theme1.css";
...
const defaultSummary =
  "              Seeking a role as a front-end developer with knowledge of programming development software.";
    ...
    <>
      <Box id="section-to-print" ref={componentRef}>
        <Box _dark={{ border: "1px solid white" }} id="theme1">
          ...
          <div style={{ 
    display: 'block', width: 800, paddingLeft: 1
}}> 
